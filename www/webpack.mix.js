...
mix.sass(
    "resources/theme/webpack/plugins/plugins.scss",
    ...
    .js(
        ["resources/theme/webpack/plugins/plugins.js"],
        "public/assets/plugins/global/plugins.bundle.js"
    );

// Build css/js
mix.sass(
    "resources/theme/sass/style.scss",
...
(glob.sync("resources/theme/plugins/custom/**/*.js") || []).forEach((file) => {
    mix.js(
        file,
        `public/assets/${file
            .replace("resources/theme/", "")
            .replace(".js", ".bundle.js")}`
    );
});
(glob.sync("resources/theme/plugins/custom/**/*.scss") || []).forEach((file) => {
    mix.sass(
        file,
        `public/assets/${file
            .replace("resources/theme/", "")
...
(glob.sync("resources/theme/sass/pages/**/!(_)*.scss") || []).forEach((file) => {
    file = file.replace(/[\\/]+/g, "/");
    mix.sass(
        file,
        file
            .replace("resources/theme/sass", "public/assets/css")
            .replace(/\.scss$/, ".css")
    );
});
...
(glob.sync("resources/theme/js/custom/**/*.js") || []).forEach((file) => {
    var output = `public/assets/${file.replace("resources/theme/", "")}`;
...
// Copy media folder
mix.copyDirectory("resources/theme/media", "public/assets/media");

(glob.sync("resources/theme/sass/themes/**/!(_)*.scss") || []).forEach((file) => {
    file = file.replace(/[\\/]+/g, "/");
    mix.sass(
        file,
        file
...
(glob.sync("resources/theme/plugins/**/*.+(woff|woff2|eot|ttf)") || []).forEach(
    (file) => {
...
mix.scripts(
    [
        ...
        "resources/theme/js/vendors/plugins/datatables.init.js",
    ],
